...
// Overwrites contains
    ...
    $('.status-code, .link.status-code').click(function() {
        var status_code = $(this).text().substr(0, 3);
        if (status_code === '200')
            window.open('http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html#sec10.2.1', '_blank');
        if (status_code === '403')
            window.open('http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html#sec10.4.4', '_blank');
        if (status_code === '400')
            window.open('http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html#sec10.4.1', '_blank');
        if (status_code === '302')
            window.open('http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html#sec10.3.3', '_blank');
        if (status_code === '401')
            window.open('http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html#sec10.4.2', '_blank');
        if (status_code === '409')
            window.open('http://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html#sec10.4.10', '_blank');
    });
