...
Insert a media object or a collection of media objects into an album
belonging to a user. Add the same Media twice in the same album is
allowed. Considering the following scenario: An album “Antarctica”
contains Photo1.jpg 

If a user selects 3 pictures, Photo1.jpg, Photo2.jpg, Photo3.jpg and
adds them to the album “Antarctica”. Album “Antarctica” will contain,
the following: Photo1.jpg, Photo1.jpg, Photo2.jpg and Photo3.jpg.
...
{\footnotesize{\input{InputParam-Add_Media_To_Album.tex}}}{\footnotesize \par}


\paragraph{Request – Example (Add media to an album in XML)\protect \\
}



This demonstrates how to add media to an album, and specifying the
...
POST /locker/v1/albums/3433435/media HTTP/1.1 
host: api.att.com
...
\paragraph{Request – Example (Add media to an album in JSON)\protect \\
}
...
{\footnotesize{\input{OutputParam-Add_Media_To_Album.tex}}}{\footnotesize \par}


\paragraph{Response – Example (Add media to an album in XML)\protect \\
}
...
\input{Errors-Add_Media_To_Album.tex}
\end{document}
