...
# From repo
time.sleep(1)
driver.get('http://ecomstgdvc03.cingular.com:8080/share/page/repository#filter=path%7C%2Fwem-projects%2Fdeveloper%2Fdeveloper%2Fwork-area%2Fsite%2Fwebsite%2Fapis%7C&page=1')
time.sleep(5)
